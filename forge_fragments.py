...
def _prompt_systeme(zone: str) -> str:
    return (
        ...
        "L'UI est sombre, moderne, en panneaux 'glass'. Le fragment sera injecte dans : " + zone + ".\n\n"
        ...
        "Reste sobre, lisible, coherent avec une UI sombre (evite les fonds clairs agressifs).\n"
